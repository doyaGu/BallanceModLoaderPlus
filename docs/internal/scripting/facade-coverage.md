...
- Generated ImGui coverage is tracked by `src/AngelScript/generated/BMLImGuiAngelScriptBindings.report.md`; the generated script stub is `docs/zh-CN/bml-imgui-api.as`.
