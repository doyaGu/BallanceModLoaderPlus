...
if (-not $SkipPlayer) {
    ...
    Add-SmokeCheck $checks 'script-owned-resource-cleanup' (Test-SmokeTextContains $modLogText 'refsInvalid=true commandRefsInvalid=true dataShareRefsInvalid=true') 'refsInvalid=true commandRefsInvalid=true dataShareRefsInvalid=true'
