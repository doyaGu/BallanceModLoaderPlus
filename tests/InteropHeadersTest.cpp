...
TEST(InteropHeadersTest, GeneratedImcCodecRoundTripsTypedValues) {
    ...
    EXPECT_FALSE(output.Paused);
    EXPECT_TRUE(output.Playing);
    EXPECT_FALSE(output.CheatEnabled);
}
TEST(InteropHeadersTest, GeneratedEventCodecRoundTripsArrayFieldsWithinInlinePayload) {
