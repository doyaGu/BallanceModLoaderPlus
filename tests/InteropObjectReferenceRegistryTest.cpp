...
TEST(InteropObjectReferenceRegistryTest, DeletionInvalidatesAReusedSlotEvenAtTheSameAddress) {
    InteropObjectReferenceRegistry references;
    int storage = 0;
...
TEST(InteropObjectReferenceRegistryTest, ResetInvalidatesEveryTrackedReference) {
    InteropObjectReferenceRegistry references;
    int firstStorage = 0;
    int secondStorage = 0;
...
TEST(InteropObjectReferenceRegistryTest, DeletionReleasesBookkeepingWithoutRevalidatingStaleRefs) {
    InteropObjectReferenceRegistry references;
    int storage = 0;
    const BML_ObjectRef first = references.Make(1, 42, &storage);
