...
BML_BEHAVIOR_ABI_ASSERT(BehaviorInterfaceMajor,
                        BML_BEHAVIOR_INTERFACE_MAJOR == 1u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorInterfaceMinor,
                        BML_BEHAVIOR_INTERFACE_MINOR == 0u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorValueAlignment,
                        BML_BEHAVIOR_VALUE_ALIGNMENT == 4u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorLastError,
...
BML_BEHAVIOR_ABI_ASSERT(BehaviorRunPrototypeOffset,
                        offsetof(BML_BehaviorRunInfo, Prototype) == 16u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorRunStatusOffset,
                        offsetof(BML_BehaviorRunInfo, Status) == 40u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorRunInfoSize,
                        sizeof(BML_BehaviorRunInfo) == 336u);
...
BML_BEHAVIOR_ABI_ASSERT(BehaviorPlanInstanceSize,
                        sizeof(BML_BehaviorPlanInstance) == 64u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorNodeRefSize,
...
BML_BEHAVIOR_ABI_ASSERT(BehaviorValueRefSize,
                        sizeof(BML_BehaviorValueRef) == 64u);
BML_BEHAVIOR_ABI_ASSERT(BehaviorWatchValueSize,
...
static int BML_BEHAVIOR_CALL BehaviorWatchSignature(
    void *state,
    const BML_BehaviorWatchEvent *event) {
    (void) state;
    (void) event;
