...
Create it with `scripts/bml.py new yourname.my-mod`. Generated projects contain
...
Select one with `scripts/bml.py new --profile ...`.

## Script Mod

- `script-mod-template`: AngelScript `*.mod.as` script mod template.
  Instantiate it with `scripts/New-BMLScriptMod.ps1`.
