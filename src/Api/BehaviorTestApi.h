...
enum BML_BehaviorTestPatchState : std::uint32_t {
    ...
    BML_BEHAVIOR_TEST_PATCH_DISABLED = 3,
    BML_BEHAVIOR_TEST_PATCH_CLOSING = 4,
    BML_BEHAVIOR_TEST_PATCH_CONFLICTED = 5,
    BML_BEHAVIOR_TEST_PATCH_CLOSED = 6,
    BML_BEHAVIOR_TEST_PATCH_FAILED = 7,
};
...
enum BML_BehaviorTestPlanState : std::uint32_t {
    ...
    BML_BEHAVIOR_TEST_PLAN_PARTIAL = 4,
    BML_BEHAVIOR_TEST_PLAN_DISABLED = 5,
    BML_BEHAVIOR_TEST_PLAN_CONFLICTED = 6,
    BML_BEHAVIOR_TEST_PLAN_RETIRING = 7,
};
