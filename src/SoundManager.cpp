...
// 3D Settings
void
SoundManager::UpdateListenerSettings(CK_SOUNDMANAGER_CAPS settingsoptions, CKListenerSettings &settings, CKBOOL set) {
    if (!m_Listener)
        return;
...
CKERROR SoundManager::OnCKInit() {
    ...
    hr = DirectSoundCreate(nullptr, &m_Root, nullptr);
