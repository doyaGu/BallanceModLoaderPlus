#ifndef BML_INTEROP_OBJECT_REFERENCE_REGISTRY_H
#define BML_INTEROP_OBJECT_REFERENCE_REGISTRY_H
 ...
 */
class InteropObjectReferenceRegistry {
public:
...
#endif // BML_INTEROP_OBJECT_REFERENCE_REGISTRY_H
