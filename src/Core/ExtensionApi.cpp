...
namespace BML::Core {
    BML_Result BML_API_ExtensionRegister(
        const char *name,
    ...
    BML_Result BML_API_ExtensionQuery(
        const char *name,
    ...
    BML_Result BML_API_ExtensionLoadVersioned(
        const char *name,
    ...
    BML_Result BML_API_ExtensionEnumerate(
        ...
        ApiRegistry::Instance().Enumerate(
            ...
            &ctx,
            BML_API_TYPE_EXTENSION // Only enumerate extensions
        );
