// Mark that we have the real ResourceApi implementation
// This prevents ModuleLoaderStub.cpp from defining conflicting stubs
#define BML_HAS_RESOURCE_API 1
...
static BML_Result BML_HandleReleaseImpl(const BML_HandleDesc* desc) {
    ...
    ControlBlock* control = nullptr;
    {
        ...
        while (true) {
            ...
            if (control->ref_count.compare_exchange_weak(current, current - 1,
...
// ============================================================================
// Resource API Implementation Functions (for macro registration)
// ============================================================================
