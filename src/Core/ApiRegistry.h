...
public:
    ...
    struct ApiMetadata {
        ...
        ApiMetadata(const ApiMetadata& other) 
            : name(other.name), id(other.id), pointer(other.pointer),
              version_major(other.version_major), version_minor(other.version_minor),
              version_patch(other.version_patch), capabilities(other.capabilities),
              type(other.type), threading(other.threading),
              provider_mod(other.provider_mod), description(other.description),
              api_size(other.api_size), call_count(other.call_count.load()) {}
