...
static const ScriptIntegerConstantDescriptor kErrorConstants[] = {
    ...
    {"const int ERROR_FROZEN", BML_ERROR_FROZEN},
    {"const int ERROR_NOT_FOUND", BML_ERROR_NOT_FOUND},
    {"const int ERROR_NOT_IMPLEMENTED", BML_ERROR_NOT_IMPLEMENTED},
    {"const int ERROR_OUT_OF_MEMORY", BML_ERROR_OUT_OF_MEMORY},
    {"const int ERROR_INVALID_PARAMETER", BML_ERROR_INVALID_PARAMETER},
    {"const int ERROR_ACCESS_DENIED", BML_ERROR_ACCESS_DENIED},
    {"const int ERROR_TIMEOUT", BML_ERROR_TIMEOUT},
    {"const int ERROR_BUSY", BML_ERROR_BUSY},
    {"const int ERROR_ALREADY_EXISTS", BML_ERROR_ALREADY_EXISTS},
    {"const int ERROR_INVALID_HANDLE", BML_ERROR_INVALID_HANDLE},
    {"const int ERROR_WOULD_BLOCK", BML_ERROR_WOULD_BLOCK},
    {"const int ERROR_CANCELLED", BML_ERROR_CANCELLED},
    {"const int ERROR_WRONG_THREAD", BML_ERROR_WRONG_THREAD},
    {"const int ERROR_MALFORMED_MESSAGE", BML_ERROR_MALFORMED_MESSAGE},
    {"const int ERROR_TYPE_MISMATCH", BML_ERROR_TYPE_MISMATCH},
    {"const int ERROR_VERSION_MISMATCH", BML_ERROR_VERSION_MISMATCH},
    {"const int ERROR_IMC_ENDPOINT_NOT_FOUND", BML_ERROR_IMC_ENDPOINT_NOT_FOUND},
    {"const int ERROR_IMC_HANDLE_STALE", BML_ERROR_IMC_HANDLE_STALE},
    {"const int ERROR_IMC_UNSUPPORTED", BML_ERROR_IMC_UNSUPPORTED},
    {"const int ERROR_IMC_API_MISMATCH", BML_ERROR_IMC_API_MISMATCH},
    {"const int ERROR_IMC_PROVIDER_UNLOADED", BML_ERROR_IMC_PROVIDER_UNLOADED},
    {"const int ERROR_UNAVAILABLE", BML_ERROR_UNAVAILABLE},
    {"const int ERROR_OBJECT_INVALID", BML_ERROR_OBJECT_INVALID},
    {"const int ERROR_BUFFER_TOO_SMALL", BML_ERROR_BUFFER_TOO_SMALL},
    {"const int ERROR_IMC_SCHEMA_MISMATCH", BML_ERROR_IMC_SCHEMA_MISMATCH},
