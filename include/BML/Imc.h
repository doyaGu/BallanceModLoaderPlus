...
// something of its own; Scene.h, Gameplay.h, and Events.h are already written on top of
// it for what the loader itself offers. Runtime.h, Speedrun.h, and UI.h answer out of a
